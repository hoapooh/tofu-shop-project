<%-- 
    Document   : income
    Created on : Mar 7, 2024, 10:13:08 PM
    Author     : anphu
--%>
...
<html lang="en">
    ...
    <body>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <ul class="list">
                        ...
                        <li class="item"><a href="#!">Income</a></li>
        ...
        <main class="main-user main-income">
            <div class="content">
                    ...
                    <tbody class="table-content-body">
                        <c:forEach items="${listOrder}" var="ord">
                            <tr class="item">
                                ...
                                <td>${ord.date}</td>
                                <td>${ord.amount}</td>
                                <td><a href="vieworder?ordid=${ord.orderId}">View Details</a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
            ...
            <div class="income-total">
                <div class="content">
                    <p class="desc">Total Order: ${requestScope.numOrder}</p>
                    <p class="desc">Total Income: ${requestScope.totalIncome}</p>
                    <p class="desc"></p>
                </div>
            </div>
        </main>
