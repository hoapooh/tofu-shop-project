...
public class SearchController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Nếu muốn search sản phẩm bằng tiếng Việt thì dùng dòng lệnh này
        ...
        List<Products> listSearch = proDAO.searchByName(txtSearch);
        
        request.setAttribute("listProDiscount", listP);
        request.setAttribute("listLatestPro", listLP);
        request.setAttribute("listMo", listM);
        request.setAttribute("listPro", listSearch);
        request.setAttribute("txtSave", txtSearch);
