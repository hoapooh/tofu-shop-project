...
public class IncomeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ProductOrder> listPO = poDAO.getAllOrder();
        int numOrd = poDAO.getNumberOrder();
        double totalIncome = odDAO.getTotalIncome();
        
        request.setAttribute("listOrder", listPO);
        request.setAttribute("numOrder", numOrd);
