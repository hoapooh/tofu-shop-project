...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .add_product .item label {
                margin-bottom: 2px;
            }
            .add_product .item input,
            .add_product .item textarea,
            .add_product .item select {
                padding: 10px;
            ...
            .add_product .item_last select {
                padding: 5px;
            }

            .add_product .form_footer {
                text-align: right;
            }

            .add_product .form_footer input {
                cursor: pointer;
            }
        </style>
    </head>
    ...
    <body>
        ...
        <main class="main-user main-add-product">
            <div class="content">
                ...
                <form action="add" method="post" class="add_product">
