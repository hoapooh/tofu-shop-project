<%-- 
    Document   : viewOrder
    Created on : Mar 12, 2024, 10:51:22 PM
    Author     : anphu
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <main class="main-user main-view-order">
            <div class="content">
                <a href="./income" class="back-btn">Back</a>
                ...
                <table class="table-content">
                    ...
                    <c:forEach items="${listOrderDetail}" var="od">
                        <tr class="item">
                            ...
                            <td><img src="${od.productimage}" class="image-table" /></td>
                            <td>$ ${od.unitPrice}</td>
                            <td>${od.quantity}</td>
                        </tr>
                    </c:forEach>
